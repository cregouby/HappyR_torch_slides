...
`r fontawesome::fa("check", fill = fa_fill)` R & RStudio installés?

     J'ai R 4.4.2 and 2024.12.0 build 67
...
| famille     |  packages        |
|-------------|------------------|
| fondations  | ![](images/tile_torch_tools.png) |
| vision      | ![](images/tile_torch_vision.png) |
| données tabulaires| ![](images/tile_torch_tabular.png) |
| traitement automatique du langage| ![](images/tile_torch_nlp.png) |
| séries temporelles| ![](images/tile_torch_ts.png) |

: Les paquets par famille de donnée traitées
:::
...
| {luz} | `r fontawesome::fa("check", fill = fa_fill)` | `r fontawesome::fa("check", fill = fa_fill)` [cregouby/luz.fr](https://github.com/cregouby/luz.fr) | `r fontawesome::fa("check", fill = fa_fill)` [cregouby.github.io/luz.fr/](https://cregouby.github.io/luz.fr/)|
...
| {minhub} |  | `r fontawesome::fa("check", fill = fa_fill)` [cregouby/minhub.fr](https://github.com/cregouby/minhub.fr) |  |
